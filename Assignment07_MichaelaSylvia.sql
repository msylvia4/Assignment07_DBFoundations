...
-- 05/29/2024,MichaelaSylvia,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_MichaelaSylvia')
	 Begin 
	  Alter Database [Assignment07DB_MichaelaSylvia] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_MichaelaSylvia;
	 End
	Create Database Assignment07DB_MichaelaSylvia;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_MichaelaSylvia;
...
Order By ProductName, InventoryDate, PreviousMonthCount, [CountvsPreviousMonthCountKPI];
go
...
Where [CountvsPreviousMonthCountKPI] = @KPIValue
go
